...
from .config import current_identity, load_platform, load_user_config
...
class Shell:
    def __init__(self):
        ...
        self.user_cfg = load_user_config(self.identity, self.cfg.users_file)
...
container is deleted. NAT IPv4 and the service-port numbers are
...
'''
    ...
    def dispatch_command(self, command: str) -> int:
        ...
        # CommandDispatcher intentionally receives Incus argv without
        # the public leading "incus" token.
        if argv[0] == 'incus':
    ...
    def interactive(self) -> int:
        ...
        print(f'Management ID: {self.management_id:03d}')
...
# Compatibility with the temporary v2 wiring that referenced this name.
IncusOnlyShell = Shell
